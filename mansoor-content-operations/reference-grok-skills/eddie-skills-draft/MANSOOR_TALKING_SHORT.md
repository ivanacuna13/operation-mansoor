# Mansoor talking short (this video)

Brand pack format for **Operation Mansoor talking-head shorts** — the specific video he cut in Premiere on 2026-08-12 (`how to clip screen recording.mp4`). Not the global ClipEdit workflow. Not TOF lifestyle. Shared pipeline still runs; this pack is how *this* Mansoor talking clip should look and cut.

Source: `Desktop/AIDA/how-to-clip-watch/` (stills + ElevenLabs transcript).

If you are an agent: he is in Premiere. Do the visual equivalent for **this format only**.
