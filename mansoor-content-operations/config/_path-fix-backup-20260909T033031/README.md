...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/voiceedit_episode.py all \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/voiceedit_episode.py final \
  --episode /path/to/episode
```
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/voiceedit_episode.py status \
  --episode /path/to/episode \
  --mode proxy
```
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/elevenlabs_audio_cleanup.py clean-media \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/elevenlabs_audio_cleanup.py isolate \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/elevenlabs_audio_cleanup.py mux \
  --video /path/to/PROXY_REVIEW_episode.mp4 \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/voiceedit_deliver_final.py \
  --episode /path/to/episode \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/audit_base_cut.py \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/render_hybrid_hosts_guest.py \
  --config /path/to/episode_config.yaml \
  --map /path/to/base_cut_map.json \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/render_remote_three_person.py \
  --config /path/to/episode_config.yaml \
  --map /path/to/base_cut_map.json \
  --output output/PROXY_REVIEW_episode.mp4 \
  --quiet \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py oauth-status
```

Check the token:

```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py check-auth
```
...
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py oauth-web-login \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py list-accounts

python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py list-workspaces \
  --account-id FRAMEIO_ACCOUNT_ID

python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py list-projects \
  --account-id FRAMEIO_ACCOUNT_ID \
  --workspace-id FRAMEIO_WORKSPACE_ID

python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py list-children \
  --account-id FRAMEIO_ACCOUNT_ID \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py upload-review \
  --episode /path/to/episode \
  --account-id FRAMEIO_ACCOUNT_ID \
  --folder-id FRAMEIO_FOLDER_ID \
  --project-id FRAMEIO_PROJECT_ID \
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py upload-proxy \
  --episode /path/to/episode \
  --account-id FRAMEIO_ACCOUNT_ID \
  --folder-id FRAMEIO_FOLDER_ID \
  --project-id FRAMEIO_PROJECT_ID
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py create-share \
  --episode /path/to/episode \
  --kind base_cut \
  --project-id FRAMEIO_PROJECT_ID
```
...
```bash
python3 /home/box/mansoor-content-operations/tools/voiceedit/frameio_review.py fetch-comments \
  --episode /path/to/episode \
  --kind base_cut
```
