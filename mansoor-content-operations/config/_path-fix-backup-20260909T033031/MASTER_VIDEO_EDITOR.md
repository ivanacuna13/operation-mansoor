...
```
python3 /home/box/mansoor-content-operations/tools/master-video-editor/mve.py submit --packet-file /path/to/job.json
```
...
- `CODEX_VM_WORKSPACE=/home/box/mansoor-content-operations`
...
SQLite at `/home/box/mansoor-content-operations/state/master-video-editor.sqlite`
...
1. `sales_call_clip` → `/home/box/.codex/skills/mansoor-sales-call-clips/SKILL.md` → TYPE `BOF Sales Call Clips` → `#sf-video-ready-to-review` `C0BVAAVASV7`
2. `scripted_talking_head` → `/home/box/.codex/skills/mansoor-talking-head-scripted-reels/SKILL.md` → TYPE `BOF Scripted Talking Heads` → `#sf-video-ready-to-review` `C0BVAAVASV7`
3. `genius_clip` → `/home/box/.codex/skills/mansoor-genius-clips/SKILL.md` → TYPE `MOF Genius Clips` (registry also labels `Genius Clip`) → `#sf-video-ready-to-review` `C0BVAAVASV7`
4. `lifestyle_copycat` → `/home/box/.codex/skills/mansoor-tof-copycat-editor/SKILL.md` → TYPE `TOF Copy Cats` / `Lifestyle Copycat` → delivery `#lifestyle-copycats` `C0BQTR6RP97`
...
codex exec --skip-git-repo-check --json \
  ...
  --add-dir /home/box/.codex/skills \
  --add-dir /home/box/mansoor-content-operations/tools/voiceedit \
...
`/home/box/mansoor-content-operations/config/mve-scheduler.json`
